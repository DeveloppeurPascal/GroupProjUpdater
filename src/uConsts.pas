...
const
  ...
  /// </summary>
  CAboutURL = 'https://groupprojupdater.olfsoftware.fr';
  ...
  CSupportURL =
    ...
    // TODO : à basculer sur le site du logiciel lorsqu'il sera disponible
  ...
  /// </remarks>
  CProjectFolderName = 'GroupProjUpdater';
